...
void ConfigureServices(IServiceCollection services)
{
    ...
    //Set up App Settings
    services.Configure<OmsAppSettings>(builder.Configuration);
...
void Configure(IApplicationBuilder app, IWebHostEnvironment env)
{
    ...
    if (swaggerEnabled)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            ...
            c.SwaggerEndpoint("v1/swagger.json", "BlendNet OMS API V1");
        });
    }
...
void ConfigureHttpClients(IServiceCollection services)
{
    ...
    string incentiveBaseUrl = builder.Configuration.GetValue<string>("IncentiveBaseUrl");
