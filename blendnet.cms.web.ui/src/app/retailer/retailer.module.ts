...
@NgModule({
  declarations: [ReferralsComponent, RetailerHomeComponent, RetailerDashboardComponent, RetailerCommissionsComponent, RetailerCommissionDialogComponent, RatesIncentivesComponent, RetailerMilestonesComponent],
  imports: [
    CommonModule,
    CMSMaterialModule,
    CarouselModule ,
