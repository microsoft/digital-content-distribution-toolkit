...
void ConfigureServices(IServiceCollection services)
{
   ...
   .AddJsonOptions(options =>
   {
    ...
    services.AddSwaggerGen(c =>
    {
        ...
        {
            Version = "v1",
            Title = "BlendNet Device API",
            Description = "Web API to manage devices on BlendNet platform.",
    ...
    //Set up App Settings
    services.Configure<DeviceAppSettings>(builder.Configuration);
...
void Configure(IApplicationBuilder app, IWebHostEnvironment env)
{
    ...
    if (swaggerEnabled)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            ...
            c.SwaggerEndpoint("v1/swagger.json", "BlendNet Device API V1");
        });
    }
