...
void ConfigureServices(WebApplicationBuilder builder)
{
   ...
   .AddJsonOptions(options =>
   {
    ...
    //Set up App Settings
    services.Configure<UserAppSettings>(builder.Configuration);
...
void ConfigureHttpClients(IServiceCollection services)
{
    ...
    string notificationBaseUrl = builder.Configuration.GetValue<string>("NotificationBaseUrl");
